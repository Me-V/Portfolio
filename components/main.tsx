...
const projects = [
  {
    title: "Lively Docs",
    description: "A live collaborative text editor made with Next.js and Live Blocks",
    tech: [
  ...
  {
    title: "Cloud Aura",
    description: "A real-time cloud storage app made with Next.js and Convex Database",
    tech: [
      { name: "Next.js", icon: SiNextdotjs, color: "000000" },
...
export default function Main() {
  return (
    <div style={containerStyle}>
      <section className="pt-32 pb-16 relative id='work'">
          ...
          >
            <button className="relative px-8 py-3 rounded-full bg-surface border border-white/10 hover:border-primary/10 transition-all group">
              <Link href="https://github.com/Me-V">
                <span className="text-content transition-colors relative z-[1]">View All Projects</span>
              </Link>
